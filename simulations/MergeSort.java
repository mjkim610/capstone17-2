///https://github.com/savanibharat/Java-Data-Structures/tree/master/src/com/MergeSortByThreading/HighlyParallelMergeSort
...
public class MergeSort {
	...
	public static void main(String[] args) throws Throwable {
		...
		for (int i = 1; i <= RUNS; i++) {
			...
			System.out.printf("%13d elements  =>  %9d ns \n", LENGTH, endTime1
					- startTime1);
	...
	public static int[] createRandomArray(int length) {
	 ...
	 public static void showMemory() {
         ...
         System.out.println("Bytes;; Max:" + format.format(max) + ", Total:" + format.format(total) + ", Free:"+format.format(free));          
}
}